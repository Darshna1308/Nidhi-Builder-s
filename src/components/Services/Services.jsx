...
function Services() {
  ...
  const services = [
...

    {
      ...
      desc:"Construction is our core expertise. We collaborate with experienced architects to provide professionally designed plans before construction begins.",
...

    {
      ...
      desc:"We undertake comprehensive renovation and redevelopment works for premium residential and commercial properties, focusing on large-scale transformations.",
...

    {
      ...
      desc:"We assist clients in identifying suitable plots and developing premium homes tailored to their vision and lifestyle.",
      highlight:"From plot selection to dream home delivery."
    },

    {
      icon:<KeyRound size={40}/>,
      title:"Turnkey Construction Solutions",
      desc:"From planning coordination and construction to finishing and final handover, we manage every stage of your project.",
      highlight:"Single point responsibility from concept to completion."
    }
